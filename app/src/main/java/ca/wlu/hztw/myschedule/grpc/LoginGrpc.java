...
public final class LoginGrpc {
  ...
  public static final io.grpc.MethodDescriptor<ca.wlu.hztw.myschedule.grpc.CalenderServices.LoginRequest,
      ca.wlu.hztw.myschedule.grpc.CalenderServices.LoginResult> METHOD_LOGIN = getLoginMethod();

  private static volatile io.grpc.MethodDescriptor<ca.wlu.hztw.myschedule.grpc.CalenderServices.LoginRequest,
      ca.wlu.hztw.myschedule.grpc.CalenderServices.LoginResult> getLoginMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<ca.wlu.hztw.myschedule.grpc.CalenderServices.LoginRequest,
      ca.wlu.hztw.myschedule.grpc.CalenderServices.LoginResult> getLoginMethod() {
    io.grpc.MethodDescriptor<ca.wlu.hztw.myschedule.grpc.CalenderServices.LoginRequest, ca.wlu.hztw.myschedule.grpc.CalenderServices.LoginResult> getLoginMethod;
    if ((getLoginMethod = LoginGrpc.getLoginMethod) == null) {
      synchronized (LoginGrpc.class) {
        if ((getLoginMethod = LoginGrpc.getLoginMethod) == null) {
          LoginGrpc.getLoginMethod = getLoginMethod = 
              io.grpc.MethodDescriptor.<ca.wlu.hztw.myschedule.grpc.CalenderServices.LoginRequest, ca.wlu.hztw.myschedule.grpc.CalenderServices.LoginResult>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "ca.wlu.hztw.myschedule.grpc.Login", "login"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ca.wlu.hztw.myschedule.grpc.CalenderServices.LoginRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ca.wlu.hztw.myschedule.grpc.CalenderServices.LoginResult.getDefaultInstance()))
  ...
  public static abstract class LoginImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void login(ca.wlu.hztw.myschedule.grpc.CalenderServices.LoginRequest request,
        io.grpc.stub.StreamObserver<ca.wlu.hztw.myschedule.grpc.CalenderServices.LoginResult> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ca.wlu.hztw.myschedule.grpc.CalenderServices.LoginRequest,
                ca.wlu.hztw.myschedule.grpc.CalenderServices.LoginResult>(
                  this, METHODID_LOGIN)))
          .build();
    }
  }
  ...
  public static final class LoginBlockingStub extends io.grpc.stub.AbstractStub<LoginBlockingStub> {
    ...
    /**
     */
    public ca.wlu.hztw.myschedule.grpc.CalenderServices.LoginResult login(ca.wlu.hztw.myschedule.grpc.CalenderServices.LoginRequest request) {
  ...
  public static final class LoginFutureStub extends io.grpc.stub.AbstractStub<LoginFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ca.wlu.hztw.myschedule.grpc.CalenderServices.LoginResult> login(
        ca.wlu.hztw.myschedule.grpc.CalenderServices.LoginRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LOGIN:
          serviceImpl.login((ca.wlu.hztw.myschedule.grpc.CalenderServices.LoginRequest) request,
              (io.grpc.stub.StreamObserver<ca.wlu.hztw.myschedule.grpc.CalenderServices.LoginResult>) responseObserver);
          break;
        default:
